...
def load_model():
    """Load nnsight model and tokenizer.
    ...
    for pair_idx, (q1, q2, q1_exp, q2_exp, category) in enumerate(pair_pbar):
        ...
        for condition in conditions:
            ...
            result = PairResult(
                ...
                category=category,
                condition=condition,
                q1_outputs=q1_outputs if save_raw else [],
                q2_outputs=q2_outputs if save_raw else [],
            )
...
def save_results(
    ...
    for condition, results in results_by_condition.items():
        ...
        for r in results:
            pair_data = {
                "category": r.category,
                "q1_text": r.q1_text[:100],
                "q2_text": r.q2_text[:100],
            ...
            if save_raw:
                pair_data["q1_outputs"] = r.q1_outputs
                pair_data["q2_outputs"] = r.q2_outputs
